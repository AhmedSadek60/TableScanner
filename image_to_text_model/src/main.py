...
from SamplePreprocessor import preprocess, preprocess_camera_input
import os
...
def infer_multi(model, input_dir, clean_segmented_images = True):
	...
	# delete segmented images from '../data/input_segmented' dir
	if clean_segmented_images:
...
def main():
	...
	# infer text on test image
		...
		output = infer_multi(model, FilePaths.fnInfer)
		print(output)
